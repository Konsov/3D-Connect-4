...
document.getElementById("ddlightModel").selectedIndex = lightModel; //0 direct, 1 point, 2 spot
document.getElementById("ddAmbientLight").selectedIndex = ambientLight;
document.getElementById("dddiffuse").selectedIndex = diffuseReflection;
document.getElementById("ddspecular").selectedIndex = specularReflecion;
...
document.getElementById("sliderLambert_Texture").setAttribute('value', lambertTexture);
document.getElementById("LambertColor").setAttribute('value', rgbToHex(lambertColor));
...
//SET SCREEN THAT APEPAR WHEN A GAME IS ENDED
...
//WHEN A GAME IS ENDED WE CAN TURN ON THE BOARD AND SEE THE FINAL BOARD
...
// Function that change gui on base type of light is selected and change relative variable for fs 
